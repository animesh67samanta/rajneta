...
INSERT INTO `bluetooth_slip_permissions` VALUES (1,1,1,0,0,'2025-03-03 04:20:04','2025-04-22 05:34:53');
...
CREATE TABLE `master_permissions` (
  ...
  `all_permission` tinyint(4) NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `new_addresses` VALUES (1,1,'address1','kolkata_mr',NULL,'2024-12-18 23:15:03','2025-03-11 06:45:24'),(2,2,'kolkata2',NULL,NULL,'2024-12-18 23:25:50','2024-12-18 23:25:50');
...
INSERT INTO `sms_permissions` VALUES (1,NULL,0,1,1,1,'2025-02-24 04:39:55','2025-03-12 06:55:44');
...
-- Dump completed on 2025-06-04 10:39:54
