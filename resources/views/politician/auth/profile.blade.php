...
@section('title', 'Politician Profile')
@section('content')
    <div class="page-wrapper">
        <div class="page-content">
            <!--breadcrumb-->
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Politician Profile</div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">Politician Profile</li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="container">
                <div class="main-body">
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex flex-column align-items-center text-center">
                                        <img src="{{ asset(Auth::guard('admin')->user()->image) }}" class="user-img" alt="user avatar">
                        ...
                        <div class="col-lg-8">
                            <div class="card">
                                <form action="{{ route('politician.profile.update') }}" method="post"
                        ...
                        <div class="col-lg-8">
                            <div class="card">
                                <form action="{{ route('politician.password.update') }}"
        ...
        <script>
            $(document).ready(function() {
                ...
                $('.profile_update').on('submit', function(e) {
                    ...
                    $.ajax({
                        url: '{{ route('politician.profile.update') }}',
                        type: 'POST',
                        data: formData,
                ...
                $('.change-password-form').on('submit', function(e) {
                    ...
                    $.ajax({
                        url: '{{ route('politician.password.update') }}',
                        type: 'POST',
                        data: formData,
                        success: function(response) {
                            if (response.success) {
