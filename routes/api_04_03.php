...
Route::middleware('auth:api')->group(function () {
    ...
    Route::post('/give-user-master-permission', [MasterController::class, 'masterPermission']);
     ...
     Route::get('/society-master-list', [MasterController::class, 'societyList'])->name('society.list');
     Route::get('/society-master-create', [MasterController::class, 'societyCreate'])->name('society.create');
     Route::get('/society-master-search', [MasterController::class, 'societySearch'])->name('society.search');
  

     Route::get('/address-master-list', [MasterController::class, 'addressList']);
     Route::get('/address-master-create', [MasterController::class, 'addressCreate']);
     Route::get('/address-master-search', [MasterController::class, 'addressSearch']);
    

     Route::get('/karyakarta-master-list', [MasterController::class, 'karyakartaList']);
     Route::get('/karyakarta-master-create', [MasterController::class, 'karyakartaCreate']);
     Route::get('/karyakarta-master-search', [MasterController::class, 'karyakartaSearch']);


     Route::get('/caste-master-list', [MasterController::class, 'casteList']);
     Route::get('/caste-master-create', [MasterController::class, 'casteCreate']);
     Route::get('/caste-master-search', [MasterController::class, 'casteSearch']);
  

     Route::get('/profession-master-list', [MasterController::class, 'professionList']);
     Route::get('/profession-master-create', [MasterController::class, 'professionCreate']);
     Route::get('/profession-master-search', [MasterController::class, 'professionSearch']);
